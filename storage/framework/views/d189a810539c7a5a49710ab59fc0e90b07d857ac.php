                        ...
                        <div class="profile-detail card-box">
                            <div>
                                ...
                                <ul class="list-inline status-list m-t-20">
                                    ...
                                    <li>
                                        <h3 class="text-success m-b-5"><?php echo e($user->open_sum); ?></h3>
                        ...
                        <div class="card-box">
                            <form class="form-horizontal group-border-dashed" action="/admin/saveUser" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" value="<?php echo e($user->open_sum); ?>" name="open_sum">
                                    </div>
                                </div>
                                <div class="form-group">
