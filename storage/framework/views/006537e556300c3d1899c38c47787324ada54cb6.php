                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <?php $__currentLoopData = $opens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $live): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($live->payway); ?></td>
                                        <td><?php echo e($live->amount); ?></td>
                                        <td>
                                            <a href="/admin/acceptWithdraw/<?php echo e($live->id); ?>" class="table-action-btn">Оплатить</a>
                                            <span> | </span>
                                            <a href="/admin/declineWithdraw/<?php echo e($live->id); ?>" class="table-action-btn">Отказать</a>
                                        </td>
