                        ...
                        <div class="card-box">
                            <form class="form-horizontal group-border-dashed" action="/admin/saveCase" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" required="" value="<?php echo e($case->total_given); ?>" name="total_given">
                                    </div>
                                </div>
                                <div class="form-group">
                                                ...
                                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $__currentLoopData = $itemsCase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemCase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($item->id == $itemCase): ?>
                                                            <option selected value="<?php echo e($item->id); ?>"><?php echo e($item->sell_price); ?> р.</option>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"><?php echo e($item->sell_price); ?> р.</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
