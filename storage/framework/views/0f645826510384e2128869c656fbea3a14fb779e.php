        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li class="has_sub ms-hover">
                        <a href="/admin/lastWithdraw" class="waves-effect"><i class="ti-spray"></i> <span> Запросы на вывод </span> <span class="label label-primary pull-right"><?php echo e($withdrawLast); ?></span> </a>
                    </li>
                    <li class="has_sub ms-hover">
